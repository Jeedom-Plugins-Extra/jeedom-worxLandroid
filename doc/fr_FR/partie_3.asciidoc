...
Pour simplifier la création de plugin vous pouvez inclure dans votre page le script javascript de worxLandroid pour les plugins :


----
<?php include_file('core', 'plugin.worxLandroid', 'js'); ?>
----
